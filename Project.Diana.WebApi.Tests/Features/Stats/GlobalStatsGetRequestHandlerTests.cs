...
{
    public class GlobalStatsGetRequestHandlerTests
    {
        private readonly AlbumStats _albumStats;
        private readonly BookStats _bookStats;
        private readonly GlobalStatsGetRequestHandler _handler;
        private readonly Mock<IQueryDispatcher> _queryDispatcher;
        private readonly GlobalStatsGetRequest _testRequest;
